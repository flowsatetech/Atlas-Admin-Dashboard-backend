...
const serverUrl =
  process.env.SERVER_BASE_URL || `http://localhost:${process.env.PORT || 3000}`;
    ...
    components: {
      securitySchemes: {
        cookieAuth: {
          ...
          name: "auth_token",
          description:
            "Authenticate by calling POST /api/auth/login with email + password. The server sets an HttpOnly auth_token cookie automatically. All subsequent requests use that cookie.",
        },
      },
      // Added global responses used by your existing routes
      responses: {
        Unauthorized: { description: "Access denied. Please sign in." },
    ...
    paths: {
      "/api/auth/login": {
        post: {
          ...
          summary: "Login user",
          description:
            "Authenticates via email/password. Sets an HttpOnly, Secure, SameSite=Strict auth_token cookie. Stamp is stored in DB for server-side session revocation.",
          requestBody: {
            required: true,
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    rememberMe: {
                      type: "boolean",
                      description:
                        "If true, cookie lasts 30 days; otherwise 1 hour.",
                    },
                  },
                },
              },
          ...
          responses: {
            200: {
              description:
                "Signed in successfully. auth_token cookie is set. Response includes user object with userId, firstName, lastName, email, and role (admin|staff).",
            },
      ...
      "/api/auth/signup": {
        post: {
          ...
          description:
            "Requires an active admin session (cookieAuth). Creates the user but does NOT set a cookie for the new user — the admin's session is preserved.",
          security: [{ cookieAuth: [] }],
          requestBody: {
            required: true,
            content: {
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    isAdmin: {
                      type: "boolean",
                      description:
                        "If true, the account is created with admin role. Defaults to false (staff).",
                    },
                  },
                },
              },
          ...
          responses: {
            201: {
              description:
                "Account created successfully. Response includes user object with userId, firstName, lastName, email, and role (admin|staff).",
            },
            400: {
      ...
      "/api/auth/logout": {
        post: {
          ...
          summary: "Logout user",
          description:
            "Clears auth_token cookie and nullifies the user's stamp in DB, invalidating all sessions.",
          security: [{ cookieAuth: [] }],
          responses: {
      ...
      "/api/user/profile": {
        get: {
          ...
          responses: {
            200: {
              description:
                "Fetch profile success. Response includes userId, firstName, lastName, email, and role (admin|staff).",
            },
      ...
      "/api/dashboard/metrics": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns total clients, active projects, pending tasks, and new leads with trend metadata.",
          responses: {
            200: {
      ...
      "/api/dashboard/performance": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns revenue and new-client series grouped by period buckets.",
          parameters: [
            {
              name: "period",
              in: "query",
      ...
      "/api/dashboard/projects/in-progress": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns active projects with status labels and progress percentages.",
          parameters: [
            {
              name: "limit",
              in: "query",
      ...
      "/api/dashboard/activities": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns paginated activity feed for dashboard list.",
          parameters: [
            {
              name: "page",
              in: "query",
      ...
      "/api/analytics/overview": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns visitors, page views, conversion rate, and top traffic source with trends.",
          responses: {
            200: {
      ...
      "/api/analytics/traffic": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns visits, page views, and conversion-rate series.",
          parameters: [
            {
              name: "range",
              in: "query",
              ...
              schema: {
                type: "string",
                enum: ["7d", "30d", "3months", "6months", "12months"],
                default: "7d",
              },
            },
          ],
      ...
      "/api/analytics/sources": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns traffic source percentages for source bars.",
          parameters: [
            {
              name: "range",
              in: "query",
      ...
      "/api/analytics/campaigns": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns campaign rows with impressions, clicks, conversions, conversion rate, and pagination.",
          parameters: [
            {
              name: "page",
              in: "query",
      ...
      "/api/analytics/distribution": {
        get: {
          ...
          security: [{ cookieAuth: [] }],
          description:
            "Requires `auth_token` cookie. Returns distribution values for pie chart widgets.",
          responses: {
            200: {
      ...
      "/api/projects": {
        get: {
          ...
          description:
            "Returns paginated projects with optional status filter. Always includes an infoData object with global (unfiltered) project counts.",
          security: [{ cookieAuth: [] }],
          parameters: [
            {
              name: "page",
                    ...
                    properties: {
                      ...
                      data: {
                        ...
                        properties: {
                          ...
                          infoData: {
                            $ref: "#/components/schemas/ProjectInfoData",
                          },
                        },
                      },
                    },
      ...
      "/api/projects/{projectId}": {
        get: {
          ...
          description:
            "Returns full project details including comments, team member IDs, and files.",
          security: [{ cookieAuth: [] }],
          parameters: [
            {
              name: "projectId",
        ...
        patch: {
          ...
          description:
            "Partial update — all fields optional. The project id cannot be changed.",
          security: [{ cookieAuth: [] }],
          parameters: [
            {
              name: "projectId",
        ...
        put: {
          ...
          description:
            "Used to update revenue recognition, assignees, and status. recognizedRevenue and recognizedAt must be provided together and are only allowed when status is Completed.",
          security: [{ cookieAuth: [] }],
          parameters: [
            {
              name: "projectId",
      ...
      "/api/members": {
        ...
        post: {
          ...
          description:
            "Creates a new user account with a hashed password. The admin's session is preserved — no cookie is set for the new member.",
          security: [{ cookieAuth: [] }],
          requestBody: {
            required: true,
            content: {
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    role: {
                      type: "string",
                      enum: ["admin", "staff"],
                      description: "Assign or remove admin privileges",
                    },
                    job: { type: "string" },
                    status: { type: "string" },
                  },
